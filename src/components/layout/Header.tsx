...
// Create a simple NavigationMenu component since we can't import it
const NavigationMenu = () => {
  return (
    <nav className="flex items-center justify-center space-x-6">
      ...
      <Link to="/category/clothing" className="font-medium hover:text-primary">
        Clothing
      </Link>
      <Link
      ...
      <Link to="/category/beauty" className="font-medium hover:text-primary">
        Beauty
      </Link>
      <Link to="/promotions" className="font-medium text-red-500">
        Promotions
      </Link>
    </nav>
  );
